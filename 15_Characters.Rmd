...
fileNamer <- 'Scleritomorph_phylogeny_files/figure-html/tree%s-char%s.svg'
...
if (!is.null(getOption('localInstance')) || knitr::is_html_output()) {
  ...
  CheckDirExists('_book/Scleritomorph_phylogeny_files')
  CheckDirExists('_book/Scleritomorph_phylogeny_files/figure-html')
...
```{R all-changes, echo=FALSE, fig.height=8, fig.width=7.1, fig.cap="(ref:all-changes)", results="asis"}
