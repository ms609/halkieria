...
ignored_taxa <- c('Conotheca', 'Maxilites', 'Pauxillites',
                  'Probactrotheca', 'Chaetoderma', 'Leptochiton', 
                  'Mopalia', 'Neopilina', 'Siphogonuchites_multa', 
                  'Wirenia', 'Yochelcionella_greenlandica') # Also manually update tnt.run using `taxcode-`
